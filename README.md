...
||명사 뒤에서 수식|② -ing|have difficulty (in) ___ *N(P)*|어려움을 겪다|
|||③ to 부정사|in an effort ___ *N(P)*|~을 위한 노력으로|
||명사(구) 앞에서 수식|③ 관사/소유격 대명사/형용사|||
|||④ 분사|*n* ___ *n*||
||||||
...
|||④ 분사|*prep* ___ *n*||
||||||
|형용사 ___ 명사(구)|부사구 완성|① -ing|be busy (in) ___ *NP*|바쁘다|
